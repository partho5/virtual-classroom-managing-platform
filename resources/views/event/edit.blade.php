...
<div class="container-fluid">
    <div class="col-md-12">
        ...
        <div id="middle-bar" class="col-md-9">
            ...
            <form action="/event/{{ $event->id }}" method="post" id="create-event-wrapper" class="container-fluid">
                {{ csrf_field() }}
                ...
                <div class="form-group">
                    <div class="input-group col-md-12">
                        ...
                        <div class="col-md-7">
                            <input required type="text" name="title" class="form-control" value="{{ $event->title }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="input-group col-md-12">
                        ...
                        <div class="col-md-7">
                            <input required type="text" name="keywords" class="form-control" value="{{ $event->keywords }}">
                            <input required type="hidden" name="speaker_name" id="{{ $event->speaker_id }}" value="{{ $event->speaker_id }}">
                        </div>
                    </div>
                </div>
                ...
                @if($userRole == 'Super Admin')
                    <div class="form-group pop-up">
                        <div class="input-group col-md-12">
                            ...
                            <div class="col-md-7">
                                <input required id="speaker_name" class="form-control"  type="text" value="{{ $event->speakerName }}">
                ...
                <div class="form-group">
                    <div class="input-group col-md-12">
                        ...
                        <div class="col-md-7">
                            <textarea name="abstract" class="form-control" rows="4" >{{ $event->abstract }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="input-group col-md-12">
                        ...
                        <div class="col-md-7">
                            <input required type="text" name="talk_delivery_time" id="talk_delivery_time" class="form-control" value="{{ $event->talk_delivery_time }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="input-group col-md-12">
                        ...
                        <div class="col-md-7">
                            <select name="use_dlt" id="use_dlt" class="form-control" required>
                                <option value="No" {{ $event->use_dlt == 'No' ? "selected" : "" }}>No</option>
                                <option value="Yes" {{ $event->use_dlt == 'Yes' ? "selected" : "" }}>Yes</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="input-group col-md-12">
                        ...
                        <div class="col-md-7">
                            <input required type="text" name="target_audience" class="form-control" value="{{ $event->target_audience }}">
                        </div>
                    </div>
                </div>


                    <div id="editable-by-superadmin" class="{{ $userRole == 'Super Admin' ? "":"hidden" }}">
                        <div class="form-group">
                            <div class="input-group col-md-12">
                                <label for="" class="col-md-5">Dialing Number</label>
                                <div class="col-md-7">
                                    <input required type="text" name="client_dial_num" class="form-control" value="{{ $event->client_dial_num }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group" id="username-wrapper">
                            <div class="input-group col-md-12">
                                ...
                                <div class="col-md-7">
                                    <input type="text" name="client_username" class="form-control" value="{{ $event->client_username }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group" id="pass-wrapper">
                            <div class="input-group col-md-12">
                                ...
                                <div class="col-md-7">
                                    <input type="text" name="client_password" class="form-control" value="{{ $event->client_password }}">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-12">
                                    @foreach($univInfo as $key => $univ)
                                        <p class="single-univ col-md-3">
                                            <input type="checkbox" name="univ_id_to_notify[]" value="{{ $key }}" {{ in_array($key, $event->univs) ? "checked":"" }} class="univ-name">
                        ...
                        <div class="form-group">
                            <div class="input-group col-md-12">
                                ...
                                <div class="col-md-12">
                                    Dear < username >,
                                    <textarea class="form-control" name="msg_sent_to_speaker" rows="5">{{ $event->msg_sent_to_speaker }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="input-group col-md-12">
                                ...
                                <div class="col-md-12">
                                    Dear < username >,
                                    <textarea class="form-control" name="msg_sent_to_representative" rows="5">{{ $event->msg_sent_to_speaker }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    <div class="input-group col-md-12">
                        <input required class="btn btn-success col-md-4 col-md-offset-4" type="submit" value="Save Data">
                    </div>
                </div>
            </form>
        </div>
