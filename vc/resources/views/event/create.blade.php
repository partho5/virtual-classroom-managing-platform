            ...
            <form action="/event" method="post" id="create-event-wrapper" class="container-fluid">
                ...
                <div class="form-group">
                    <div class="input-group col-md-12">
                        ...
                        <div class="col-md-7">
                            <input type="text" name="title" class="form-control" value="Fisrt BdREN Workshop on Distance Learning Education">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="input-group col-md-12">
                        ...
                        <div class="col-md-7">
                            <input type="text" name="keywords" class="form-control" value="DLE, SPOC">
                        </div>
                    </div>
                </div>
                ...
                @if($userRole == 'Super Admin')
                    <div class="form-group pop-up">
                        <div class="input-group col-md-12">
                            ...
                            <div class="col-md-7">
                                <input id="speaker_name" class="form-control"  type="text">
                ...
                <div class="form-group">
                    <div class="input-group col-md-12">
                        ...
                        <div class="col-md-7">
                            <textarea name="abstract" class="form-control" rows="4" >abs</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="input-group col-md-12">
                        ...
                        <div class="col-md-7">
                            <input type="text" name="talk_delivery_time" id="talk_delivery_time" class="form-control" value="2018-03-16 11:58">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="input-group col-md-12">
                        ...
                        <div class="col-md-7">
                            <input type="text" name="target_audience" class="form-control" value="Engineering Students">
                        </div>
                    </div>
                </div>
                ...
                @if($userRole == 'Super Admin')
                    <div class="form-group">
                        <div class="input-group col-md-12">
                            ...
                            <div class="col-md-7">
                                <input type="text" name="client_dial_num" class="form-control" value="101">
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    <div class="input-group col-md-12">
                        <input class="btn btn-success col-md-4 col-md-offset-4" type="submit" value="Create Event">
                    </div>
                </div>
            </form>
        </div>
