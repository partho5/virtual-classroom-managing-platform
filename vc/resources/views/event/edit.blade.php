            ...
            <form action="/event/{{ $event->id }}" method="post" id="create-event-wrapper" class="container-fluid">
                ...
                <div class="form-group">
                    <div class="input-group col-md-12">
                        ...
                        <div class="col-md-7">
                            <input type="text" name="keywords" class="form-control" value="{{ $event->keywords }}">
                            <input type="hidden" name="speaker_name" id="{{ $event->speaker_id }}" value="{{ $event->speaker_id }}">
                        </div>
                    </div>
                </div>
                ...
                @if($userRole == 'Super Admin')
                    <div class="form-group pop-up">
                        <div class="input-group col-md-12">
                            ...
                            <div class="col-md-7">
                                <input id="speaker_name" class="form-control"  type="text" value="{{ $event->speakerName }}">
                                <input id="speaker_id" name="speaker_id" class="form-control"  type="hidden">
                            </div>
                        </div>
                        <!--hidden-pop-up-->
                ...
                <div class="form-group">
                    <div class="input-group col-md-12">
                        ...
                        <div class="col-md-7">
                            <input type="text" name="talk_delivery_time" id="talk_delivery_time" class="form-control" value="{{ $event->talk_delivery_time }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="input-group col-md-12">
                        ...
                        <div class="col-md-7">
                            <select name="use_dlt" id="" class="form-control" required>
                ...
                <div class="form-group">
                    <div class="input-group col-md-12">
                        ...
                        <div class="col-md-7">
                            <input type="text" name="target_audience" class="form-control" value="{{ $event->target_audience }}">
                        </div>
                    </div>
                </div>
                    ...
                    <div id="editable-by-superadmin" class="{{ $userRole == 'Super Admin' ? "":"hidden" }}">
                        <div class="form-group">
                            <div class="input-group col-md-12">
                                ...
                                <div class="col-md-7">
                                    <input type="text" name="client_dial_num" class="form-control" value="{{ $event->client_dial_num }}">
                                </div>
                            </div>
                        </div>
                ...
                <div class="form-group">
                    <div class="input-group col-md-12">
                        <input class="btn btn-success col-md-4 col-md-offset-4" type="submit" value="Save Data">
                    </div>
                </div>
            </form>
        </div>
